          ...
          addedPhotos.map((link) => (
            <div className="flex relative h-32" key={link}>
              ...
              <button
                ...
                className="absolute bottom-1 right-1 bg-black bg-opacity-50 py-1 px-1 rounded-xl cursor-pointer"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1 left-1 bg-black bg-opacity-50 py-1 px-1 rounded-xl cursor-pointer"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
